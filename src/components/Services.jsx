                    ...
                    {services.map((service, index) => (
                        ...
                        >
                            ...
                            <div className="text-start flex-grow-1">
                                ...
                                <h6 className="fw-semibold">{service.title || "Professional healthcare service"}</h6>
                                <p className="fw-semibold mb-0">{service.text || "Quality medical care you can trust."}</p>
                            </div>
                        </div>
                    ))}
                </div>
